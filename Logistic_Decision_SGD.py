...
#training classifier using Logistic Regression, Decision Tree and Stochastic Gradient Descent
...
#classifying using the model that was trained using Logistic Regression
sent = classifier5.classify(testing_set_features)
