...
#classifying using the model that was trained using various SVC algorithms
...
'''
SVC Classifier accuracy percentage:  74.0
LinearSVC Classifier accuracy percentage:  73.0
NuSVC Classifier accuracy percentage:  77.0
...
sent = classifier3.classify(testing_set_features)
